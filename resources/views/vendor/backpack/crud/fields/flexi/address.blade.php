...
<div class="form-group col-md-12 mb-0">
    ...
    <div class="row" id="{{ $uniqueId }}">
        <div class="col-sm-6 col-md-6 mb-3">
            <label>{{ trans('flexi.province_city') }} @if($setRequired >= 2) <span class="label-required">*</span> @endif </label>
        ...
        <div class="col-sm-6 col-md-6 mb-3">
            <label>{{ trans('flexi.district_khan') }} @if($setRequired >= 4) <span class="label-required">*</span> @endif </label>
        ...
        <div class="col-sm-6 col-md-6 mb-3">
            <label class="no-error-label">{{ trans('flexi.commune_sangkat') }} @if($setRequired >= 6) <span class="label-required">*</span> @endif </label>
        ...
        <div class="col-sm-6 col-md-6 mb-3">
            <label class="no-error-label">{{ trans('flexi.village') }} @if($setRequired >= 8) <span class="label-required">*</span> @endif </label>
        ...
        <script>
            new Vue({
                ...
                created: async function(){
                    var me = this;
                    await this.getData().then(function(response){
