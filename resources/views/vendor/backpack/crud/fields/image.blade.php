...
@include('crud::fields.inc.wrapper_start')
    ...
    <div class="row">
    <div class="{{ ( isset($field['crop']) && $field['crop'] )? 'col-sm-6': 'col-sm-12' }}" data-handle="previewArea" style="margin-bottom: 20px;">
    ...
    <div class="btn-group">
        ...
        @endif
        <button class="btn btn-light btn-sm border-left" data-handle="remove" type="button"><i class="la la-trash"></i></button>
    </div>
