@if ($crud->hasAccess('update'))
	...
	<!-- Single edit button -->
	<a href="{{ url($crud->route.'/'.$entry->getKey().'/edit') }}" class="btn btn-sm btn-info" title="{{ trans('flexi.properties.edit') }}"><i class="la la-edit"></i></a>

	@else

	<!-- Edit button group -->
	<div class="btn-group">
	  <a href="{{ url($crud->route.'/'.$entry->getKey().'/edit') }}" class="btn btn-sm btn-info pr-0"><i class="la la-edit"></i></a>
